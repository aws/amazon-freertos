/*
 * FreeRTOS Kernel port for AVR ATMega328P
 * Author: Sergey Shcherbakov <shchers@gmail.com>
 *
 * As a base was used lib/FreeRTOS/portable/GCC/ATMega323/port.c
 */
...
#define portCLEAR_COUNTER_ON_MATCH				( 1<<WGM01 )
#define portPRESCALE_64							( (1<<CS11) | (1<<CS10) )
#define portCLOCK_PRESCALER						( ( uint32_t ) 64 )
#define portCOMPARE_MATCH_INTERRUPT_ENABLE		( 1<<OCIE0A )
...
uint8_t ucLowByte;
	...
	disabled. */
	TIMSK0 |= portCOMPARE_MATCH_INTERRUPT_ENABLE;
}
/*-----------------------------------------------------------*/
