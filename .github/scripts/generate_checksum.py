...
ALL_OPTIONAL_COMPONENTS = [
                            os.path.join('freertos_kernel', 'portable')
                          ]

# From this section: https://quip-amazon.com/QajoAe0aaN64/IDT-Support-for-FreeRTOS-Folder-Structure-Changes#RIa9CAXzuLM
...
def generate_checksums_file_schema_v2(required_files, optional_components, afr_path, output_file_path):
    ...
    for optional_component_location in optional_components:
        ...
        optional_component_checksum["checksums"] = generate_checksum_for_files(afr_path, optional_components[optional_component_location])
...
def generate_checksums_file_schema_v3(exhaustive_required_files, exhaustive_optional_components,
                                      minimal_required_files, minimal_optional_components,
                                      afr_path, output_file_path):
    '''
    Generates the checksum file for version 3 schema.
    https://quip-amazon.com/QajoAe0aaN64/IDT-Support-for-FreeRTOS-Folder-Structure-Changes
    ...
    for optional_component_location in exhaustive_optional_components:
        optional_component_checksum = {}
        optional_component_checksum["location"] = optional_component_location
        optional_component_checksum["checksums"] = generate_checksum_for_files(afr_path,
    ...
    for optional_component_location in minimal_optional_components:
        ...
        optional_component_checksum["location"] = optional_component_location
        optional_component_checksum["checksums"] = generate_checksum_for_files(afr_path,
                                                                               minimal_optional_components[optional_component_location])
...
def main():
    ...
    exhaustive_required_files = [required_file for required_file in all_required_files if required_file not in minimal_required_files]
    ...
    for optional_component_location in ALL_OPTIONAL_COMPONENTS:
        ...
        # exhaustive_optional_components.
        files_in_exhaustive_optional_component = [optional_component_file for \
                                                  optional_component_file in files_in_optional_component \
    ...
    if schema_version == 1:
        ...
        generate_checksums_file_schema_v3(exhaustive_required_files, exhaustive_optional_components,
                                          minimal_required_files, minimal_optional_components,
                                          afr_path, output_file_path)
    else:
