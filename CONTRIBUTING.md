...
1. PRs should not be too large. This prevents them to be meaningfully reviewed. We recommend submitting changes in a series of smaller PRs, each of which is thematically cohesive (i.e., focusing on a single set of related ideas/changes).
