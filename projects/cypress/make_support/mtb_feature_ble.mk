...
SOURCES+=\
	...
	$(wildcard $(CY_AFR_ROOT)/libraries/ble/src/*.c)\
	$(wildcard $(CY_AFR_ROOT)/libraries/ble/src/services/device_information/*.c)\
	$(wildcard $(CY_AFR_ROOT)/libraries/ble/src/services/mqtt_ble/*.c)\
	$(wildcard $(CY_AFR_ROOT)/libraries/ble/src/services/wifi_provisioning/*.c)\
	$(wildcard $(CY_AFR_ROOT)/libraries/ble/src/services/data_transfer/*.c)\
...
INCLUDES+=\
	...
	$(CY_AFR_ROOT)/libraries/ble\
	$(CY_AFR_ROOT)/libraries/ble/include\
	$(CY_AFR_ROOT)/libraries/ble/src

ifeq ($(CY_AFR_IS_TESTING), 1)
SOURCES+=\
	$(wildcard $(CY_AFR_ROOT)/libraries/abstractions/ble_hal/test/src/*.c)\
	$(CY_AFR_ROOT)/libraries/ble/test/iot_test_ble_end_to_end.c\
	$(CY_AFR_ROOT)/libraries/ble/test/iot_mqtt_ble_system_test.c\
	$(CY_AFR_ROOT)/libraries/ble/test/iot_test_wifi_provisioning.c\
	$(CY_AFR_ROOT)/libraries/ble/test/iot_test_ble_mqtt_serialize.c

INCLUDES+=\
	$(CY_AFR_ROOT)/libraries/abstractions/ble_hal/test/include\
	$(CY_AFR_ROOT)/libraries/ble/test
else
#Demo code
SOURCES+=\
