...
COMPONENTS+=FREERTOS
DEFINES+=BLE_SUPPORTED=$(BLE_SUPPORTED) CYBSP_WIFI_CAPABLE CY_RTOS_AWARE CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_USE_LWIP MBEDTLS_CONFIG_FILE=\"aws_mbedtls_config.h\"
...
# Add TFM defines
DEFINES+=CY_TFM_PSA_SUPPORTED TFM_MULTI_CORE_MULTI_CLIENT_CALL CY_TFM_VERSION_1_0
endif
