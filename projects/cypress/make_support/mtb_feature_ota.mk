...
# Bootloader version uses SWAP STATUS
#
ifeq ($(CY_MCUBOOT_SWAP_USING_STATUS),1)
DEFINES+=CY_MCUBOOT_SWAP_USING_STATUS=1
endif
...
ifeq ($(CY_MCUBOOT_SWAP_USING_STATUS),1)
    ...
    CY_BOOT_PRIMARY_1_SIZE=0x0011C000
    CY_BOOT_SECONDARY_1_START=0x00024400 # offset from start of external FLASH 18000000
    CY_BOOT_SECONDARY_2_START=0x0016C000 # offset from CY_FLASH_BASE
else
    MCUBOOT_BOOTLOADER_SIZE=0x00040000
    CY_BOOT_PRIMARY_1_START=0x00050000
    CY_BOOT_PRIMARY_1_SIZE=0x00120000
    CY_BOOT_SECONDARY_1_START=0x00000000 # offset from start of external FLASH 18000000
