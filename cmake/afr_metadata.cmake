...
function(afr_write_metadata)
    ...
    if(NOT AFR_IS_TESTING)
        get_target_property(demo_src aws_demos SOURCES)
        get_target_property(demo_inc aws_demos INCLUDE_DIRECTORIES)
        list(APPEND src_all ${demo_src})
        list(TRANSFORM demo_src REPLACE "${AFR_ROOT_DIR}/" "")
        list(JOIN demo_src "\n    - " demo_src)
        file(APPEND "${metadata_file}" "aws_demos:\n")
        file(APPEND "${metadata_file}" "  sources:\n")
        file(APPEND "${metadata_file}" "    - ${demo_src}\n")
        if(demo_inc)
