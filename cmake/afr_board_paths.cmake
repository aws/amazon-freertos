...
foreach(vendor IN LISTS vendors)
    file(APPEND "${cmake_supported_boards_file}" "    - vendor_name: ${vendor}\n")
    file(APPEND "${cmake_supported_boards_file}" "      vendor_path: vendors/${vendor}\n")
    file(APPEND "${cmake_supported_boards_file}" "      boards:\n")
    afr_get_vendor_boards("${vendor}" boards)
    foreach(board IN LISTS boards)
        file(APPEND "${cmake_supported_boards_file}" "        - board_name: ${board}\n")
        include("${AFR_VENDORS_DIR}/${vendor}/manifest.cmake")
        if(DEFINED AFR_MANIFEST_BOARD_DIR_${board})
            file(APPEND "${cmake_supported_boards_file}" "          board_path: ${AFR_MANIFEST_BOARD_DIR_${board}}\n")
        else()  
            file(APPEND "${cmake_supported_boards_file}" "          board_path: ${AFR_MANIFEST_BOARD_DIR}/${board}\n")
        endif()
    endforeach()
endforeach()
