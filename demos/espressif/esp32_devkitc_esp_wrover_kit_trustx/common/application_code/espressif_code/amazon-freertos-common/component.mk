...
COMPONENT_SRCDIRS := $(AMAZON_FREERTOS_LIB_DIR)/mqtt \
		...
		$(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/pal/esp32_freertos \
		...
		$(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx \
		...
		$(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/examples/authenticate_chip \
		$(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/examples/ecdsa_utils \
		$(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/examples/mbedtls_port \
...
COMPONENT_ADD_INCLUDEDIRS := $(AMAZON_FREERTOS_LIB_DIR)/FreeRTOS-Plus-TCP/include \
                             ...
                             $(AMAZON_FREERTOS_LIB_DIR)/third_party/tinycbor \
							 $(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/examples/ecdsa_utils \
							 $(AMAZON_FREERTOS_LIB_DIR)/third_party/trustx/optiga/include
