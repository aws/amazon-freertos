 ...
 * // Called when mutex has already been taken.
 */
ATCA_STATUS hal_i2c_change_baud(ATCAIface iface, uint32_t speed)
{
    ...
    //configPRINTF(("hal_i2c_change_baud called.\n"));
    ...
    {
        //configPRINTF(("hal_i2c_change_baud:: Failed to take mutex.\n"));
    }
...
ATCA_STATUS hal_i2c_init(ATCAIface iface, ATCAIfaceCfg *cfg)
{
    ...
    //configPRINTF(("hal_i2c_init:: start"));
    ...
    if(xSemaphoreTake(i2cMutex,100*portTICK_PERIOD_MS))
    {
        if (bus >= 0 && bus < MAX_I2C_BUSES)
        {
            if (0 == i2c_hal_data[bus].ref_ct)
            {
                ...
                rc = i2c_param_config(i2c_hal_data[bus].id, &i2c_hal_data[bus].conf);
                //configPRINTF(("hal_i2c_init::i2c_param_config, rc = %s, id=%d.\n", esp_err_to_name(rc), i2c_hal_data[bus].id));
                rc = i2c_driver_install(i2c_hal_data[bus].id, I2C_MODE_MASTER, 0, 0, 0);
                //configPRINTF(("hal_i2c_init::i2c_driver_install, rc = %s\n", esp_err_to_name(rc)));
            }
            else
            {
    ...
    {
        //configPRINTF(("hal_i2c_init:: Failed to take mutex.\n"));
    }
    ...
    {
        //configPRINTF(("hal_i2c_init failed, rc = %d.\n", rc));
        return ATCA_COMM_FAIL;
    }
}
...
ATCA_STATUS hal_i2c_post_init(ATCAIface iface)
{
    ...
    //configPRINTF(("hal_i2c_post_init called.\n"));
...
ATCA_STATUS hal_i2c_send(ATCAIface iface, uint8_t address, uint8_t *txdata, int txlength)
{
    ...
    //configPRINTF(("hal_i2c_send start.\n"));
    ...
    {
        //configPRINTF(("hal_i2c_send:: Failed to take mutex.\n"));
    }

    //configPRINTF(("hal_i2c_send end.\n"));
...
ATCA_STATUS hal_i2c_receive(ATCAIface iface, uint8_t address, uint8_t *rxdata, uint16_t *rxlength)
{
    ...
    //configPRINTF(("hal_i2c_receive start.\n"));
    ...
    {
        //configPRINTF(("hal_i2c_receive:: Failed to take mutex.\n"));
    }
    ...
    //configPRINTF(("hal_i2c_receive end.\n"));
...
ATCA_STATUS hal_i2c_release(void *hal_data)
{
    ...
    //configPRINTF(("hal_i2c_release called\n"));
    ...
    {
        //configPRINTF(("hal_i2c_release:: Failed to take mutex.\n"));
    }
    return ATCA_SUCCESS;
}
...
ATCA_STATUS hal_i2c_control(ATCAIface iface, uint8_t option, void* param, size_t paramlen)
{
    ...
    //configPRINTF(("hal_i2c_control called\n"));
