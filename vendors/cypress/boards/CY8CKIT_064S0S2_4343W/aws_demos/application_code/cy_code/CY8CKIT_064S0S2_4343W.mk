...
# CY_BSP_POSTBUILD=$(CY_CROSSPATH)/bin/arm-none-eabi-objcopy -R .cy_sflash_user_data -R .cy_toc_part2 $(CY_CONFIG_DIR)/$(APPNAME).elf $(CY_CM4_ELF);
# CY_BSP_POSTBUILD+=$(CY_CROSSPATH)/bin/arm-none-eabi-objcopy -O ihex $(CY_CM4_ELF) $(CY_CM4_HEX);
