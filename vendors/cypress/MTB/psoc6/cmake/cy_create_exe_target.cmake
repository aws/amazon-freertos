function(cy_config_ota_exe_target)
    ...
    if($ENV{MCUBOOT_HEADER_SIZE})
        ...
        elseif("${AFR_TOOLCHAIN}" STREQUAL "arm-iar")
            target_link_options(${ARG_EXE_APP_NAME} PUBLIC "SHELL:--define_symbol MCUBOOT_HEADER_SIZE=$ENV{MCUBOOT_HEADER_SIZE}")
        endif()
    endif()
    if($ENV{MCUBOOT_BOOTLOADER_SIZE})
        ...
        elseif("${AFR_TOOLCHAIN}" STREQUAL "arm-iar")
            target_link_options(${ARG_EXE_APP_NAME} PUBLIC "SHELL: --define_symbol MCUBOOT_BOOTLOADER_SIZE=$ENV{MCUBOOT_BOOTLOADER_SIZE}")
        endif()
    endif()
    if($ENV{CY_BOOT_PRIMARY_1_SIZE})
        ...
        elseif("${AFR_TOOLCHAIN}" STREQUAL "arm-iar")
            target_link_options(${ARG_EXE_APP_NAME} PUBLIC "SHELL: --define_symbol CY_BOOT_PRIMARY_1_SIZE=$ENV{CY_BOOT_PRIMARY_1_SIZE}")
        endif()
    endif()
