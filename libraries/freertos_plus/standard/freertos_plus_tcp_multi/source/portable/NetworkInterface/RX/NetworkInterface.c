...
static BaseType_t pxRX65_NetworkInterfaceInitialise( NetworkInterface_t *pxInterface );

static BaseType_t pxRX65_NetworkInterfaceOutput( NetworkInterface_t *pxInterface, NetworkBufferDescriptor_t * const pxBuffer, BaseType_t bReleaseAfterSend );

static BaseType_t pxRX65_GetPhyLinkStatus( NetworkInterface_t *pxInterface );

NetworkInterface_t *pxRX65_FillInterfaceDescriptor( BaseType_t xNumber, NetworkInterface_t *pxInterface );
...
static NetworkEndPoint_t xEndPoints[ 2 ];
	pxRX65_FillInterfaceDescriptor( 0, &( xInterfaces[0] ) );
...
NetworkInterface_t *pxRX65_FillInterfaceDescriptor( BaseType_t xEMACIndex, NetworkInterface_t *pxInterface )
{
...
or global, and that it will continue to exist. */
	...
	pxInterface->pfInitialise		= pxRX65_NetworkInterfaceInitialise;
	pxInterface->pfOutput			= pxRX65_NetworkInterfaceOutput;
	pxInterface->pfGetPhyLinkStatus = pxRX65_GetPhyLinkStatus;
...
/***********************************************************************************************************************
 * Function Name: pxRX65_NetworkInterfaceInitialise ()
 * Description  : Initialization of Ethernet driver.
 * Arguments    : none
 * Return Value : pdPASS, pdFAIL
 **********************************************************************************************************************/
BaseType_t pxRX65_NetworkInterfaceInitialise( NetworkInterface_t *pxInterface )
{
    BaseType_t xReturn;
 ...
 **********************************************************************************************************************/
static BaseType_t pxRX65_NetworkInterfaceOutput( NetworkInterface_t *pxInterface,
...
static void prvEMACDeferredInterruptHandlerTask( void * pvParameters )
{
    ...
    for( ; ; )
    {
        ...
        BaseType_t xStatus;
            ...
            if( phy_get_link_status ( 0 ) == R_PHY_OK )
            {
            	xStatus = 1;
            }
            else
...
void prvLinkStatusChange( BaseType_t xStatus )
{
static BaseType_t xLastStatus;

    if( xLastStatus != xStatus )
    {
