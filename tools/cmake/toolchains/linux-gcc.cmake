...
# Find GCC for Linux
afr_find_compiler(AFR_COMPILER_CC gcc)
afr_find_compiler(AFR_COMPILER_CXX g++)

find_program(GCOV gcov PATHS /usr/local/bin /usr/bin /bin)
find_program(LCOV lcov PATHS /usr/local/bin /usr/bin /bin)
find_program(GENHTML genhtml PATHS /usr/local/bin /usr/bin /bin)
